...
public class UserToKafka {
    ...
    private static final String dataFilePath = "/home/hduser/Ecom-Recommend-Algo/data/jdata_user.csv.gz";
        ...
        try {
            ...
            while (reader.ready()) {
                if (reader.ready() && (line = reader.readLine()) != null) {
                    ...
                    producer.send(new ProducerRecord<String, String>("user_profile", line));

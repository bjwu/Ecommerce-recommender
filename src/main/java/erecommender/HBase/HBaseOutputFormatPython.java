...
public class HBaseOutputFormatPython implements org.apache.flink.api.common.io.OutputFormat<JDBehaviorlog> {
    ...
    private static TableName tableName = TableName.valueOf("action_train_log");
    ...
    public void writeRecord(JDBehaviorlog log) throws IOException {
        Put put = new Put(Bytes.toBytes(log.getStrUserId()+","+log.getTimeStamp())); //rowkey
